...
public class ZipUtils {
    ...
    public static void main(String[] args) throws Exception {
        /** 测试压缩方法1 */
        //FileOutputStream fos1 = new FileOutputStream(new File("D:\\zip\\mytest01.zip"));
        //ZipUtils.toZip("D:\\upload", fos1, true);
        /** 测试压缩方法2 */
 		List<File> fileList = new ArrayList<>();
 		fileList.add(new File("D:/upload/0.png"));
 		fileList.add(new File("D:/upload/1.png"));
 		fileList.add(new File("D:/upload/2.png"));
 		fileList.add(new File("D:/upload/3.png"));
 		FileOutputStream fos2 = new FileOutputStream(new File("D:/zip/mytest02.zip"));
